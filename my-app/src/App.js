...
import './App.css';
import { imgResize } from "./Resize.js"
var game = new Game();
...
function App() {
    ...
    <div id="backGround">
		<div id="totalFrame">
			...
			<motion.div id="fightFrame">  
				<div id="beFighter">
					<div style={{position:"relative",top:"25px"}}>{playerFight_components}</div>
				</div>
			...
			<motion.div id="victoryCel">	</motion.div>	{/* 胜利玩家庆祝指示器 */}
